class CfgPatches {class tsp_rhs_m4 {requiredAddons[] = {"tsp_rhs_weapon"}; units[] = {}; skipWhenMissingDependencies = 1;};};
...
class CfgWeapons {
	...
	class rhs_weap_m4_moe: rhs_weap_m4 {
	...
	class rhs_weap_m4_moe_tan: rhs_weap_m4_moe {
	...
	class rhs_weap_m4a1_handguard: rhs_weap_m4a1_carryhandle {
		baseWeapon = "rhs_weap_m4a1_handguard"; displayName = "M4A1 (Plastic Handguard)"; picture = "\tsp_rhs_m4\m4.paa";
		hiddenSelectionsTextures[] = {"\tsp_rhs_weapon\tex\m4a1_noris.paa"};
		...
		class rhs_weap_m4a1_car: rhs_weap_m4a1_handguard {
		displayName = "M4A1 (CAR Stock)";
		baseWeapon = "rhs_weap_m4a1_car";
		hiddenSelectionsTextures[] = {"\tsp_rhs_weapon\tex\m4a1_nostock.paa"};
		class linkedItems {class linkedItemsUnder {slot = "underBarrelSlot"; item = "rhs_acc_m4_car_bipod";};};
		class WeaponSlotsInfo: WeaponSlotsInfo {class underBarrelSlot {linkProxy = "\A3\data_f_mark\proxies\weapon_slots\UNDERBARREL"; class compatibleItems {rhs_acc_m4_car_bipod = 1;};};};
	};
	
	class rhs_weap_m4a1_handguard_car: rhs_weap_m4a1_handguard {
		displayName = "M4A1 (Plastic Handguard/CAR Stock)";
		baseWeapon = "rhs_weap_m4a1_handguard_car";
		hiddenSelectionsTextures[] = {"\tsp_rhs_weapon\tex\m4a1_noris_nostock.paa"};
		class linkedItems {class linkedItemsPointer {slot = "pointerSlot"; item = "rhs_acc_m4_car_pointer";}; class linkedItemsUnder {slot = "underBarrelSlot"; item = "rhs_acc_m4_handguard";};};
		class WeaponSlotsInfo: WeaponSlotsInfo {class pointerSlot {linkProxy = "\a3\data_f\proxies\weapon_slots\SIDE"; class compatibleItems {rhs_acc_m4_car_pointer = 1;};};};
	};
	
	class rhs_weap_m4a1_moe: rhs_weap_m4a1 {
		baseWeapon = "rhs_weap_m4a1_moe"; displayName = "M4A1 (Magpul MOE)"; magazines[] = {"rhs_mag_30Rnd_556x45_M855A1_PMAG"}; model = "\rhsusf\addons\rhsusf_weapons\M4\m4_ris_mstock.p3d";
		hiddenSelectionsTextures[] = {"\tsp_rhs_weapon\tex\m4a1_noris.paa", "\rhsusf\addons\rhsusf_weapons\m4\data\magazine_co.paa", "\rhsusf\addons\rhsusf_weapons\m4\data\m4acc_co.paa", "\tsp_rhs_weapon\tex\empty.paa", "\rhsusf\addons\rhsusf_weapons\acc\grips\grippod\data\acc_co.paa", "\rhsusf\addons\rhsusf_weapons\m4\data\magpulstock_co.paa"};
		hiddenSelectionsMaterials[] = {"\rhsusf\addons\rhsusf_weapons\m4\data\m4a1_actual.rvmat", "\rhsusf\addons\rhsusf_weapons\m4\data\magazine.rvmat", "\rhsusf\addons\rhsusf_weapons\m4\data\m4acc_co.rvmat", "\tsp_rhs_weapon\tex\empty.rvmat"};
		class linkedItems {class linkedItemsUnder {slot = "underBarrelSlot"; item = "rhs_acc_m4_moe";};};
		class WeaponSlotsInfo: WeaponSlotsInfo {
			class gripodSlot {}; 
	...
	class rhs_weap_m4a1_moe_tan: rhs_weap_m4a1_moe {
		baseWeapon = "rhs_weap_m4a1_moe_tan"; displayName = "M4A1 (Magpul MOE/Tan)"; magazines[] = {"rhs_mag_30Rnd_556x45_M855A1_PMAG_Tan"};  model = "\rhsusf\addons\rhsusf_weapons\M4\m4_ris_mstock.p3d";
		hiddenSelectionsTextures[] = {"\tsp_rhs_weapon\tex\m4a1_noris.paa", "\rhsusf\addons\rhsusf_weapons\m4\data\magazine_co.paa", "\rhsusf\addons\rhsusf_weapons\m4\data\m4acc_co.paa", "\tsp_rhs_weapon\tex\empty.paa", "\rhsusf\addons\rhsusf_weapons\acc\grips\grippod\data\acc_co.paa", "\rhsusf\addons\rhsusf_weapons\m4\data\magpulstock_d_co.paa"};
		class linkedItems {class linkedItemsUnder {slot = "underBarrelSlot"; item = "rhs_acc_m4_moe_tan";};};
	};	
};